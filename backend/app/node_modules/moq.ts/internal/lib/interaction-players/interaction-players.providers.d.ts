 ...
 * @hidden
 */
export declare const interactionPlayersProviders: ({
    ...
    deps: (typeof Presets | typeof ExpressionMatcher)[];
    useValue?: undefined;
} | {
    ...
    deps: (typeof PresetPlayer | typeof PlayablePresetProvider | typeof PresetPlayablesUpdater)[];
    useValue?: undefined;
} | {
