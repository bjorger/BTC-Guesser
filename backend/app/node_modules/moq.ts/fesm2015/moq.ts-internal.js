...
const typeExplorersProviders = [
    ...
    { provide: REFLECT_HAS, useValue: ɵ0$2, deps: [] },
];
...
const ɵ0$3 = Reflect.apply;
/**
 * @hidden
 */
const interactionPlayersProviders = [
    { provide: REFLECT_APPLY, useValue: ɵ0$3, deps: [] },
...
const ɵ0$4 = ({ target }) => new PrototypeStorage(target);
/**
 * @hidden
 */
const interceptorsProviders = [
    ...
    { provide: PrototypeStorage, useFactory: ɵ0$4, deps: [MOCK_OPTIONS] },
...
const ɵ0$5 = (mock, presets) => (target) => new PresetBuilder(mock, preset => presets.add(preset), target);
/**
 * @hidden
 */
...
export { ApplyTrap, ArgumentsMatcher, CallCounter, CallbackPresetPlayer, CallbacksPreset, CommonTypeProvider, ConstantFormatter, ConstantMatcher, DateMatcher, EqualConstantMatcher, EqualMatcher, ExpectedExpressionFormatter, ExpectedExpressionReflector, ExpressionFormatter, ExpressionHasMethodExplorer, ExpressionHasPropertyExplorer, ExpressionMatcher, FunctionMatcher, GetPropertyExpressionFormatter, GetPropertyExpressionMatcher, GetPrototypeOfTrap, GetTrap, HasMethodExplorer, HasPropertyExplorer, HasTrap, InOperatorFormatter, InOperatorInteractionExplorer, InOperatorMatcher, InteractionPlayer, IterableTester, IteratorMatcher, MapMatcher, MembersMethodExplorer, MembersPropertyExplorer, MethodExpressionFormatter, MethodExpressionMatcher, MimicsPreset, MimicsPresetPlayer, MockOptionsBuilder, NamedMethodExpressionFormatter, NamedMethodExpressionMatcher, ObjectHasMethodExplorer, ObjectHasPropertyExplorer, ObjectMapProvider, ObjectMatcher, POJOMatcher, PRESET_BUILDER_FACTORY, PlayablePresetProvider, PresetBuilder, PresetHasInOperatorExplorer, PresetHasMethodExplorer, PresetHasPropertyExplorer, PresetPlayablesUpdater, PresetPlayer, Presets, PrimitiveMatcher, PropertiesValueStorage, PropertyDescriptorProvider, PropertyIsReadOnlyTester, PropertyKeyFormatter, PrototypeStorage, ProxyFactory, REFLECT_APPLY, REFLECT_HAS, ReturnsPreset, SequenceId, SetPropertyExpressionFormatter, SetPropertyExpressionMatcher, SetPrototypeOfTrap, SetTrap, SpyFunctionProvider, ThrowsPreset, TrackedExpressionsFormatter, Tracker, Type, TypesMatcher, Verifier, VerifyError, VerifyFormatter, equalMatchersProviders, expressionMatchersProviders, formattersProviders, interactionPlayersProviders, interceptorsProviders, mockOptionsProviders, playablesProviders, presetsProviders, reflectorProviders, stringify, trackerProviders, typeExplorersProviders, verificationProviders, ɵ0$2 as ɵ0, Injector as ɵa, NullInjector as ɵb, OBJECT_MATCHERS as ɵc, InjectionToken as ɵd };
//# sourceMappingURL=moq.ts-internal.js.map
